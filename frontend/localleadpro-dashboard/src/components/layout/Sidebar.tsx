...
import {
  ...
  BarChart2, Settings, ChevronLeft, ChevronRight, LogOut, Home, Heart, AtSign, CreditCard
} from 'lucide-react';
...
const ICON_MAP: Record<string, React.ElementType> = {
  LayoutDashboard, GitBranch, Clock, Users, Send, Inbox, BarChart2, Settings, AtSign, CreditCard,
};
