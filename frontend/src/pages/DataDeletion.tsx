...
export default function DataDeletion() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-white relative overflow-hidden">
      ...
      <motion.main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-40 pb-24 relative z-10 flex flex-col items-center" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={defaultViewport}>
        ...
        <motion.div variants={fadeInUp}>
          <div className="w-24 h-24 bg-black rounded-full flex items-center justify-center mb-8 border border-white/30 shadow-[0_0_40px_rgba(0,0,0,0.1)] animate-float">
        ...
        <motion.div className="w-full bg-black rounded-2xl border border-[#eaeaea] shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden" variants={staggerItem}>
          <div className="p-8 border-b border-[#eaeaea]">
            ...
            <div className="bg-[#fafafa] border border-[#eaeaea] rounded-xl p-6 flex flex-col items-center hover:bg-black hover:shadow-minimal transition-all">
              <span className="text-sm font-bold text-[#999999] uppercase tracking-wider mb-2">Send an email to</span>
              <a href="mailto:admin@colddsam.com?subject=Data Deletion Request" className="text-2xl font-bold text-white hover:underline transition-colors">
                admin@colddsam.com
              </a>
            </div>
          </div>
