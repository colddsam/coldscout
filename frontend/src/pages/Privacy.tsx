...
export default function Privacy() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-lg h-96 bg-white rounded-full blur-[120px] opacity-[0.03] pointer-events-none -z-10" />
          ...
          <motion.section className="bg-surface-2 rounded-2xl p-8 border border-white/10 text-left" variants={staggerItem}>
            ...
            <div className="prose prose-sm max-w-none text-[#8A8A8A]">
              ...
              <div className="mt-6 p-4 rounded-xl bg-white/[0.02] border border-white/10 flex items-center justify-between transition-colors hover:bg-white/5 hover:border-white/20">
                <div>
                  <p className="font-medium text-white">Privacy & DPO Contact</p>
                  <a href="mailto:admin@colddsam.com" className="text-white hover:underline font-medium transition-colors">
                    admin@colddsam.com
                  </a>
                </div>
              </div>
