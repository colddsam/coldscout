...
const STATIC_ROUTE_META = {
    ...
    '/docs': {
        ...
        description: 'Complete setup guide for Cold Scout: system architecture, Google Maps API, Groq AI, Supabase database, environment variables, Docker deployment.',
        canonical: `${SITE_URL}/docs`,
        ogType: 'article',
    },
    '/faq': {
        title: 'FAQ — Cold Scout AI Lead Generation Platform',
        description: 'Frequently asked questions about Cold Scout — product capabilities, pricing tiers, integrations, MCP server, AI models, and GDPR compliance.',
        canonical: `${SITE_URL}/faq`,
    },
    '/compare': {
        title: 'Cold Scout vs Apollo vs Outreach vs Instantly — Comparison',
        description: 'Honest side-by-side comparison of Cold Scout against Apollo, Outreach, and Instantly. Pricing, AI features, data sources, and where each tool wins.',
        canonical: `${SITE_URL}/compare`,
    },
    '/use-cases': {
        title: 'Use Cases — Cold Scout for Freelancers, Agencies, SaaS, AI Agents',
        description: 'Cold Scout use cases for freelancers, marketing agencies, SaaS go-to-market teams, and AI agent builders.',
    ...
    '/blog': {
        ...
        description: 'Articles, comparisons, and how-tos on AI lead generation, B2B outreach automation, and the engineering of modern sales pipelines.',
...
function resolveContent(path, contentMeta) {
...
export default async function handler(req, res) {
    ...
    let meta = resolveStatic(path) ?? resolveContent(path, contentMeta);
